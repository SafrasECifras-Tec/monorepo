...
const InfoTooltip = ({ text }: { text: string }) => {
  return (
    <div className="relative group flex items-center justify-center">
      <Info className="w-4 h-4 text-muted-foreground group-hover:text-muted-foreground transition-colors cursor-help" />
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-[280px] p-3 bg-slate-800 text-white text-[13px] leading-relaxed rounded-lg shadow-elevated opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none text-center">
        {text}
...
const CustomTooltipCCL = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="bg-card p-3 border border-border shadow-elevated rounded-lg">
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 mb-2">
          <h2 className="text-lg font-bold text-foreground uppercase tracking-wide">Capital Circulante Líquido</h2>
          <span className="text-muted-foreground">-</span>
          <p className="text-muted-foreground">Mostra a capacidade de honrar as dívidas no curto prazo.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* CCL */}
            {vis.ccl && <GlassCard className="p-0 flex flex-col overflow-visible border-border/60 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Capital Circulante Líquido (CCL)</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-1">Déficit Atual</h4>
                    <div className={`text-3xl font-black tracking-tight ${last?.ccl >= 0 ? 'text-primary' : 'text-destructive'}`}>{last ? `${last.ccl >= 0 ? '' : '-'}R$ ${Math.abs(last.ccl).toFixed(1)} Mi` : '-'}</div>
                  </div>
                ...
                <p className="text-[10px] text-muted-foreground italic text-right mt-2">*Última Avaliação</p>
              </div>
            </GlassCard>}

            {/* Compromissos */}
            {vis.compromissos_prazo && <GlassCard className="p-0 flex flex-col overflow-visible border-border/60 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-lg font-semibold text-foreground">Compromissos Curto x Longo prazo</h3>
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-6 mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs md:text-sm text-muted-foreground">Passivo Circulante</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-[#cbd5e1] shrink-0"></div>
                    <span className="text-xs md:text-sm text-muted-foreground">Passivo Não Circulante</span>
                  </div>
                </div>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-2">O que o resultado diz?</h4>
                ...
                <ul className="text-sm text-muted-foreground leading-relaxed space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-muted-foreground shrink-0"></span>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 mb-2">
          <h2 className="text-lg font-bold text-foreground uppercase tracking-wide">Índices de Liquidez</h2>
          <span className="text-muted-foreground">-</span>
          <p className="text-muted-foreground">Mostra a capacidade de honrar os compromissos</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Liquidez Imediata */}
            {vis.liquidez_imediata && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Liquidez Imediata</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-2">O que o resultado diz?</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <span className="font-bold text-destructive">Atenção:</span> Seu caixa imediato cobre apenas 10% das dívidas que vencem agora. Risco alto de insolvência.
                </p>
              </div>
            </GlassCard>}

            {vis.liquidez_corrente && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Liquidez Corrente</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-2">O que o resultado diz?</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <span className="font-bold text-destructive">Atenção:</span> Para cada R$ 1,00 de dívida de curto prazo, a empresa possui R$ 0,87 em ativos circulantes. Risco de não honrar compromissos de curto prazo.
                </p>
              </div>
            </GlassCard>}

            {vis.liquidez_geral && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Liquidez Geral</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-2">O que o resultado diz?</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <span className="font-bold text-primary">Confortável:</span> A empresa possui R$ 3,17 para cada R$ 1,00 de dívida total (curto e longo prazo), indicando boa solvência no longo prazo.
                </p>
              </div>
            </GlassCard>}
        </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 mb-2">
          <h2 className="text-lg font-bold text-foreground uppercase tracking-wide">Índices de Endividamento</h2>
          <span className="text-muted-foreground">-</span>
          <p className="text-muted-foreground">Relação Capital Próprio x Capital de Terceiros</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {vis.endividamento_pl && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Endividamento sobre o Patrimônio Líquido</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-1">Endividamento Atual</h4>
                    <div className={`text-3xl font-black tracking-tight ${last?.endividamentoPL <= 50 ? 'text-primary' : 'text-destructive'}`}>{last ? `${last.endividamentoPL.toFixed(2)}%` : '-'}</div>
                  </div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <span className="font-bold text-primary">Melhora:</span> Seu endividamento está em um nível controlado, abaixo dos 50% recomendados para o seu perfil de operação. Houve uma redução de 11,3% em relação ao fechamento do ano.
                </p>
              </div>
            </GlassCard>}

            {vis.grau_endividamento && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Grau de Endividamento</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-1">Grau Atual</h4>
                    <div className={`text-3xl font-black tracking-tight ${last?.grauEndividamento <= 40 ? 'text-primary' : 'text-destructive'}`}>{last ? `${last.grauEndividamento.toFixed(2)}%` : '-'}</div>
                  </div>
                  <div className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-bold flex items-center gap-1">
                    <TrendingDown className="w-4 h-4" />
                    -7.7%
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <span className="font-bold text-primary">Melhora:</span> A dependência de capital de terceiros diminuiu 7,7%, indicando uma empresa mais sustentada por recursos próprios.
                </p>
              </div>
            </GlassCard>}
        </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-2 mb-2">
          <h2 className="text-lg font-bold text-foreground uppercase tracking-wide">Patrimônio Líquido</h2>
          <span className="text-muted-foreground">-</span>
          <p className="text-muted-foreground">Mostra os recursos próprios disponíveis da empresa</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {vis.patrimonio_liquido && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Patrimônio Líquido</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-1">Patrimônio Atual</h4>
                    <div className="text-3xl font-black text-green-600 tracking-tight">{last ? `R$ ${last.plMi.toFixed(1)} Mi` : '-'}</div>
                  </div>
                  <div className="bg-success/10 text-green-700 px-3 py-1 rounded-full text-sm font-bold flex items-center gap-1">
            ...
            {vis.patrimonio_liquido_terras && <GlassCard className="p-0 flex flex-col overflow-visible border-primary/20 shadow-soft">
              <div className="p-4 md:p-6 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-6">
                  <h3 className="text-lg font-semibold text-foreground">Patrimônio Líquido (Excluindo Terras)</h3>
              ...
              <div className="bg-accent/80 border-t border-border/50 p-4 md:px-6 rounded-b-2xl">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h4 className="text-xs font-bold text-foreground uppercase tracking-widest mb-1">Liquidez Real Atual</h4>

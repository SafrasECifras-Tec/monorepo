      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
        ...
        <GlassCard className="p-4 md:p-6 flex flex-col justify-between relative overflow-hidden group hover:shadow-elevated transition-all duration-300 border-border/60">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex flex-col">
              <span className="text-foreground font-semibold text-lg">Ativo Circulante</span>
            </div>
          </div>
        ...
        <GlassCard className="p-4 md:p-6 flex flex-col justify-between relative overflow-hidden group hover:shadow-elevated transition-all duration-300 border-border/60">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex flex-col">
              <span className="text-foreground font-semibold text-lg">Ativo Não Circulante</span>
            </div>
          </div>

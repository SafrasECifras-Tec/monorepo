      ...
      >
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <Tooltip cursor={CHART_CURSOR} content={<SafraTooltip />} />
            <Legend
            ...
            <Bar dataKey="custeios"           stackId="a" fill={DEBT_CHART_COLORS.custeios}           shape={stackedTopRadius(data, 'custeios',           SAFRA_KEYS)} barSize={36} isAnimationActive={false} />

            {/* Investimentos — meio */}
            <Bar dataKey="investimentos"      stackId="a" fill={DEBT_CHART_COLORS.investimentos}      shape={stackedTopRadius(data, 'investimentos',      SAFRA_KEYS)} barSize={36} isAnimationActive={false} />

            {/* Investimentos em Dólar — topo */}
            <Bar dataKey="investimentosDolar" stackId="a" fill={DEBT_CHART_COLORS.investimentosDolar} shape={stackedTopRadius(data, 'investimentosDolar', SAFRA_KEYS)} barSize={36} isAnimationActive={false}>
